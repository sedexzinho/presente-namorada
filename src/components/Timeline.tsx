...
const defaultMoments = [
  {
    ...
    text: "Eu ainda lembro do nervosismo que eu estava sentindo naquele dia. Só de pensar que eu finalmente ia tocar na pessoa que tanto desejei pela tela do celular por pouco mais de 3 meses. Eu lembro de tudo desse dia, de você, da minha sogra e da vó Edna olhando pra mim e eu sem nem saber o que falar, mas aos poucos fui me soltando. Depois disso a gente foi no Play Center, tiramos um monte de fotos e ficamos a tarde inteira por lá até dar a hora de ir embora. Lembro da gente no cantinho da saída do shopping, só esperando meu sogro chegar pra buscar vocês, e a gente lá conversando como se tivéssemos todo o tempo do mundo.",
    image: moment1,
  },
  {
    date: "24/12/2023",
    title: "Primeiro Natal juntos",
    text: "Quem diria que a nossa primeira data comemorativa juntos seria logo no Natal, né? Eu lembro como se fosse ontem… a gente saindo toda hora pra caminhar, só pra ter mais tempo de conversar, andando pelo condomínio onde você morava. E o mais louco é que até hoje eu lembro daquele cantinho que era nosso, onde a gente sentava, conversava sobre tudo e parecia que o tempo simplesmente parava. Era simples… mas, ao mesmo tempo, era tudo. Lembro até da vergonha que passei perguntando pros meus sogros se a gente podia ir ver Netflix. Lembro também da gente tentando jogar vôlei e... coitada de você...",
    image: moment2,
  },
  {
    date: "26/01/2024",
